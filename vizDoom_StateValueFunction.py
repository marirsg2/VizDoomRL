...
viz_doom_reward = viz_doom_reward/100.0
...
print model.predict(test_image_data[111:114]) , test_reward_data[111:114]
print model.predict(test_image_data[163:170]) , test_reward_data[163:170]
